	...
	<div class="main-content-inner">
      ...
      <div class="row">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <textarea name="ket_barang_masuk" rows="3" class="form-control"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
        ...
        <div class="col-md-12">
          <div class="widget-box">
            <div class="widget-header">
              <h4 class="widget-title">Data Barang Masuk</h4>
...
var table_find_barang
  $(document).ready(function () {
    ...
    $('body').on( 'dblclick', '#tb_select_barang tbody tr', function (e) {
      ...
      $("#BTN_SAVE").click(function(){
        ...
        if(save_method == 'save') {
            urlPost = "<?php echo site_url('barangmasuk/saveData') ?>";
        }else{
            urlPost = "<?php echo site_url('barangmasuk/updateData') ?>";
            formData+="&id_barang_masuk="+id_data
        }
  ...
  function REFRESH_DATA(){
    ...
    var tb_data =  $("#tb_data").DataTable({
        ...
        "responsive": true,
        "ajax": {
            "url": "<?php echo site_url('barangmasuk/getAllData') ?>",
            "type": "POST",
        },
        "columns": [
  ...
  function ACTION(urlPost, formData){
    ...
    function deleteData(id){
      ...
      urlPost = "<?php echo site_url('barangmasuk/deleteData') ?>";
      formData = "id_barang_masuk="+id
      ACTION(urlPost, formData)
    }
</script>