		...
		<div class="page-content">
          ...
          <div class="widget-box">
            <div class="widget-header">
              <h4 class="widget-title" id="judul_entry">Cetak Laporan Customer Complaint</h4>
            ...
            <div class="widget-body">
              <div class="widget-main">
                <form id="FRM_DATA" action="<?php echo base_url('report/ctkComplaint') ?>" method="POST" target="_blank">
                  <div>
                    <label>
                        Dari
                    </label>
